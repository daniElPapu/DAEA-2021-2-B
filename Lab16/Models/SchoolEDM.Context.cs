...
namespace Lab16.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarPorCualquiera_Result> BuscarPorCualquiera(string cualquiera)
        {
            var cualquieraParameter = cualquiera != null ?
                new ObjectParameter("Cualquiera", cualquiera) :
                new ObjectParameter("Cualquiera", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPorCualquiera_Result>("BuscarPorCualquiera", cualquieraParameter);
        }
